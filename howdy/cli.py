...
parser.add_argument(
	"command",
	help="The command option to execute, can be one of the following: add, clear, config, scan, disable, list, remove, snapshot, test or version.",
	metavar="command",
	choices=["add", "clear", "config", "disable", "list", "remove", "scan", "snapshot", "test", "version"])
